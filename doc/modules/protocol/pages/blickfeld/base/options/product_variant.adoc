...
| PRODUCT_VARIANT_QBPROTECT ^| 2 | QbProtect - Tailored product variant for long range security & protection applications.
| PRODUCT_VARIANT_QBPROTECT_S ^| 5 | QbProtect S - Tailored product variant for short range security & protection applications.
