...
.2+| *minimum_reflectivity_range_limit* | optional xref:blickfeld/base/config/range.adoc#_blickfeld_base_config_Range_Float[base.config.Range.Float] | - | m 
...
.2+| *maximum_range* | optional float| - | m 
3+| Set upper threshold for range. 
