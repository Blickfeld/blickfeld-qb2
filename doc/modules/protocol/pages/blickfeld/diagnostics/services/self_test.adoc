...
.2+| *self_tests* | repeated xref:blickfeld/diagnostics/config/self_test.adoc#_blickfeld_diagnostics_config_SelfTest[config.SelfTest] | - | - 
...
.2+| *report* | xref:blickfeld/diagnostics/data/self_test_report.adoc#_blickfeld_diagnostics_data_SelfTestReport[data.SelfTestReport] | - | - 
3+| Test report
