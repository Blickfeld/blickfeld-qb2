...
| *xref:#Set[]* | xref:blickfeld/flow/services/credentials.adoc#_blickfeld_flow_services_CredentialsSetRequest[CredentialsSetRequest]| xref:#_google_protobuf_Empty[google.protobuf.Empty]
| *xref:#Get[]* | xref:#_google_protobuf_Empty[google.protobuf.Empty]| xref:blickfeld/flow/services/credentials.adoc#_blickfeld_flow_services_CredentialsGetResponse[CredentialsGetResponse]
|===
[#Set]
== Set
...
.2+| *credentials* | xref:#_google_protobuf_Struct[google.protobuf.Struct] | - | - 
