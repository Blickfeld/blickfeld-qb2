...
| *xref:#Set[]* | xref:blickfeld/flow/services/settings.adoc#_blickfeld_flow_services_SettingsSetRequest[SettingsSetRequest]| xref:#_google_protobuf_Empty[google.protobuf.Empty]
| *xref:#Get[]* | xref:#_google_protobuf_Empty[google.protobuf.Empty]| xref:blickfeld/flow/services/settings.adoc#_blickfeld_flow_services_SettingsGetResponse[SettingsGetResponse]
|===
[#Set]
== Set
...
.2+| *settings* | xref:#_google_protobuf_Struct[google.protobuf.Struct] | - | - 
