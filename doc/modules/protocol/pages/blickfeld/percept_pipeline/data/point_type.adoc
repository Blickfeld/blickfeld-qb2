...
| POINT_TYPE_EXCLUDED ^| 4 | The point is excluded by applying an exclusion zone.
| POINT_TYPE_SHADOW ^| 8 | The point is part of a shadow.
| POINT_TYPE_FILTERED ^| 16 | The point is removed by applying a filter to the foreground point cloud.
