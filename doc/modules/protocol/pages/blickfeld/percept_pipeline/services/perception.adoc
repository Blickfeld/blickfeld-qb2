...
| *xref:#ResetBackground[]* | xref:blickfeld/percept_pipeline/services/perception.adoc#_blickfeld_percept_pipeline_services_PerceptionResetBackgroundRequest[PerceptionResetBackgroundRequest]| xref:#_google_protobuf_Empty[google.protobuf.Empty]
|===
[#Get]
== Get
