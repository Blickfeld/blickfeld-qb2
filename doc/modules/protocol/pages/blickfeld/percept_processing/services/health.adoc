...
| *xref:#Watch[]* | xref:#_google_protobuf_Empty[google.protobuf.Empty]| xref:blickfeld/percept_processing/services/health.adoc#_blickfeld_percept_processing_services_HealthWatchResponse[HealthWatchResponse]Stream 
| *xref:#Get[]* | xref:#_google_protobuf_Empty[google.protobuf.Empty]| xref:blickfeld/percept_processing/services/health.adoc#_blickfeld_percept_processing_services_HealthGetResponse[HealthGetResponse]
|===
[#Watch]
== Watch
...
.2+| *health* | xref:blickfeld/percept_processing/data/health.adoc#_blickfeld_percept_processing_data_Health[data.Health] | - | - 
