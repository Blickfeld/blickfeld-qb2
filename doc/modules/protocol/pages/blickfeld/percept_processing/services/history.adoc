...
.2+| *zone_coverage* | optional xref:blickfeld/core_processing/data/frame.adoc[core_processing.data.Frame] | - | - 
3+| Historical zone coverage point cloud 
 
Only available for zones where a minimum coverage is configured.
