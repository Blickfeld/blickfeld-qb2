...
.2+| *point_cloud_type* | xref:blickfeld/percept_pipeline/data/point_cloud_type.adoc#_blickfeld_percept_pipeline_data_PointCloudType[percept_pipeline.data.PointCloudType] | - | - 
3+| The type of point cloud to stream

.2+| *coordinate_system* | xref:blickfeld/percept_pipeline/data/coordinate_system.adoc#_blickfeld_percept_pipeline_data_CoordinateSystem[percept_pipeline.data.CoordinateSystem] | - | - 
...
.2+| *point_cloud* | xref:blickfeld/core_processing/data/frame.adoc#_blickfeld_core_processing_data_Frame[core_processing.data.Frame] | - | - 
