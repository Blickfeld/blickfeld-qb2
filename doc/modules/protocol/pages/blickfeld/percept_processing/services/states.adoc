...
| *xref:#Get[]* | https://protobuf.dev/reference/protobuf/google.protobuf/#empty[google.protobuf.Empty]| xref:blickfeld/percept_processing/services/states.adoc#_blickfeld_percept_processing_services_StatesGetResponse[StatesGetResponse]
|===
[#Stream]
== Stream
...
A method to get states messages from the pipeline

[#_blickfeld_percept_processing_services_StatesGetResponse]
=== Response

Get response containing states message

.Available fields in blickfeld.percept_processing.services.StatesGetResponse
|===
| Field | Type | Default | Unit
