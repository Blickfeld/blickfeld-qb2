...
.2+| *accelerometer_data* | xref:blickfeld/core_processing/data/acceleration.adoc#_blickfeld_core_processing_data_Acceleration[core_processing.data.Acceleration] | - | - 
3+| accelerometer data is assumed to be expressed in the lidar coordinate frame

.2+| *lidar_frame* | optional xref:blickfeld/core_processing/data/frame.adoc#_blickfeld_core_processing_data_Frame[core_processing.data.Frame] | - | - 
...
.2+| *alignment* | xref:blickfeld/base/geometry/transform.adoc#_blickfeld_base_geometry_Transform[base.geometry.Transform] | - | - 
...
.2+| *frame* | xref:blickfeld/core_processing/data/frame.adoc#_blickfeld_core_processing_data_Frame[core_processing.data.Frame] | - | - 
3+| lidar frame used for aligning the 3d point clouds

.2+| *transform* | xref:blickfeld/base/geometry/transform.adoc#_blickfeld_base_geometry_Transform[base.geometry.Transform] | - | - 
...
.2+| *transformations* | repeated xref:blickfeld/base/geometry/transform.adoc#_blickfeld_base_geometry_Transform[base.geometry.Transform] | - | - 
