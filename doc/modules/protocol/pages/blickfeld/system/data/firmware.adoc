...
3+| no bundle is available and no installation is happening
...
3+| reboot has been triggered after successful installation
...
state when reboot of the device has been triggered after successful installation
