...
| *xref:#Get[]* | xref:#_google_protobuf_Empty[google.protobuf.Empty]| xref:blickfeld/system/services/health.adoc#_blickfeld_system_services_HealthGetResponse[HealthGetResponse]
| *xref:#Watch[]* | xref:#_google_protobuf_Empty[google.protobuf.Empty]| xref:blickfeld/system/services/health.adoc#_blickfeld_system_services_HealthWatchResponse[HealthWatchResponse]Stream 
|===
[#Get]
== Get
...
.2+| *health* | xref:blickfeld/system/data/health.adoc#_blickfeld_system_data_Health[data.Health] | - | - 
3+| Health state
