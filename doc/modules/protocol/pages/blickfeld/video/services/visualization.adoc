...
| *xref:#Get[]* | xref:blickfeld/video/services/visualization.adoc#_blickfeld_video_services_VisualizationGetRequest[VisualizationGetRequest]| xref:blickfeld/video/services/visualization.adoc#_blickfeld_video_services_VisualizationGetResponse[VisualizationGetResponse]
